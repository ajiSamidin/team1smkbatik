<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid row">
        <div class="card card-primary card-outline col-sm-3">
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3" style="display: flex;">
                  <li class="list-group-item">
                    <b>Jumlah Pemilih</b> <a class="float-right">1,322</a>
                  </li>
                  <li class="list-group-item">
                    <b>Pemilih</b> <a class="float-right">543</a>
                  </li>
                  <li class="list-group-item">
                    <b>Total Suara</b> <a class="float-right">13,287</a>
                  </li>
                </ul>
        ...
        <!-- data calon ketua osis -->
              ...
              <div class="card-body row" style="display: flex; border-bottom: 2px solid black">
                ...
                <div class="icon col-sm-2">
                  ...
                  <p class="text-muted">purworejo</p>
                </div>
                <div class="icon col-sm-2">
                  <strong><i class="fa fa-id-card mr-1"></i> NIS</strong>
                  <p class="text-muted">1231</p>
                </div>
              ...
              <div class="card-body row" style="display: flex;">
                <div class="icon col-sm-2">
                  ...
                  <div class="icon col-sm-2">
                    ...
                    <p class="text-muted">121345678</p>
                </div>
                <div class="icon col-sm-2">
                  <strong><i class="fa fa-map-marker mr-1"></i> Alamat</strong>
                 ...
                 <div class="icon col-sm-2">
                  <strong><i class="fa fa-id-card mr-1"></i> NIS</strong>
                   ...
                   <p class="text-muted">45673</p>
                </div>
                <div class="icon col-sm-2">
                  <strong><i class="fa fa-star mr-1"></i>Agama</strong>

                   <p class="text-muted">kristen</p>
                </div>
                <div class="icon col-sm-2">
                  <strong><i class="fa fa-mars mr-1"></i><i class="fa fa-venus mr-1"></i> Jenis-Kelamin</strong>
