        			...
        			<form class="form-horizontal">
		                <div class="card-body">
		                    ...
		                    <div class="form-group row">
			                    ...
			                    <div class="col-sm-10">
			                      <div class="card" style="padding: 10px">admin</div>
			                    </div>
		                    </div>
		                    <div class="form-group row">
			                    <label for="inputPassword3" class="col-sm-2 col-form-label">Password</label>
			                    <div class="col-sm-10">
			                      <div class="card" style="padding: 10px">admin123</div>
			                    </div>
		                    </div>
		                    <div class="form-group row">
			                    <label for="inputPassword3" class="col-sm-2 col-form-label">no-HP</label>
			                    <div class="col-sm-10">
			                      <div class="card" style="padding: 10px">0987654321</div>
			                    </div>
		                    </div>
		                </div>
                <!-- /.card-body -->
	                <div class="card-footer row">
	                  <div class="col-sm-6">
	                  	<a href="edit.php"><button type="submit" class="btn btn-info">Edit Data</button></a>
	                  </div>
	                  <div class="col-sm-6">
	                  	<button type="submit" class="btn btn-warning float-right">Pensiun</button>
	                  </div>
	                </div>
                <!-- /.card-footer -->
             		 </form>
