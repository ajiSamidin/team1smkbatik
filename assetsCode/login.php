...
if (isset($_POST['kirim'])) {
  ...
  $ambil = "select * from user where username = '$username' && password = '$sandi' ";

  $konek = mysqli_query($masuk, $ambil);

    while ($list = mysqli_fetch_assoc($konek)) {
      $nama = $list['name'];
      $pangkat = $list['level']; 
    }
    ...
    if ($pangkat == "admin") {
      ...
      $_SESSION['nama'] = $nama;
      $_SESSION['tingkat'] = $pangkat;

      header("location: home.php");
    }elseif ($pangkat == "calon") {
      $_SESSION['id'] = $username;
      $_SESSION['nama'] = $nama;
      $_SESSION['tingkat'] = $pangkat;
      ...
      echo "<h1>Maaf Login Salah Silahkan Ulangi Lagi</h1>";
    }   
}
